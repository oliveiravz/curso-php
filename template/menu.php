<nav class="modulos">
    ...
    <div class="modulo laranja-escuro">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=namespace&file=subnamespaces">Sub-Namespace</a></li>
    ...
    <div class="modulo roxo-escuro">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=includes/desafio&file=final">Desafio do Módulo</a></li>
        </ul>
    </div>
    <div class="modulo azul-escuro">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=classes_objetos&file=data">Desafio data</a></li>
            ...
            <li><a href="exercicio.php?dir=classes_objetos&file=traits">Traits#01</a></li>
            <li><a href="exercicio.php?dir=classes_objetos&file=trait2">Traits#02</a></li>
    ...
    <div class="modulo vermelho-escuro">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=funcoes&file=args_retorno">Argumento e Retorno</a></li>
    ...
    <div class="modulo roxo">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=array&file=desafio_index">Desafio Índice</a></li>
            ...
            <li><a href="exercicio.php?dir=array&file=comparacao">Comparacao de arrays</a></li>
        </ul>
    </div>
    <div class="modulo azul">
        <h3>4. Estrutura de controle</h3>
        <ul>
